...
(
    ...
    // The RDMX target address where the ABM gets stored
    output reg[31:0] abm_addr,

    // Will strobe high when an ABM should be transmitted
    output reg start,
...
localparam REG_RUN         = 2;
localparam REG_QSFP_STAT   = 3;
//==========================================================================
...
// This is high when both abm-generators are idle
wire abm_gen_idle = (idle0 & idle1);
wire abm_gen_busy = ~abm_gen_idle;
...
always @(posedge clk) begin
    ...
    // If we're not in reset, and a read-request has occured...        
        ...
        case (ashi_rindx)
            ...
            REG_RUN:       ashi_rdata <= abm_gen_busy;
            REG_QSFP_STAT: ashi_rdata <= sync_aligned;
